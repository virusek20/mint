...
## Contributor thanks
- https://github.com/jeremyabel (jabelsjabels) - For helping with the original mod
- https://github.com/twinturbo1234 (Perfect Pizza) - For fixing issues with GLTF conversion, various accuracy improvements to the file manipulation and batch processing that handles PS1 color lookup tables and VRAM layouts
...
Commits after the pre-vibe branch (tag v1.0.1) have been created with the help of a LLM. If you're not a fan of that, feel free to download an old version or backport the changes by hand, PRs are welcome!
